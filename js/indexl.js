var S = {
  ...
  init: function () {
    ...
    // 默认显示的内容（简化为生日祝福）
    S.UI.simulate("Hi 母亲|祝你|生日快乐|happy birthday|#countdown 3||");
    ...
    S.Drawing.loop(function () {
      ...
      if (m == 700) {
         document.getElementById('myAudio1').play()
           ...
           document.querySelector('.htmleaf-container').style.display = 'none'
...
// 简化的 UI 模块（仅保留 simulate 方法用于触发动画）
S.UI = (function () {
  var interval,
    sequence = [],
    cmd = "#",
